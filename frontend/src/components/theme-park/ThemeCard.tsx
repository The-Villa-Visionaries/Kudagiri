    ...
    return (
        <div className="w-[calc(50%-10px)] bg-white rounded-2xl overflow-hidden group">
            ...
            <div className="p-4">
                ...
                <p className="text-[#558282]">Where your relationship ends faster than you can say "I love you"</p>
