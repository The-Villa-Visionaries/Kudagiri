        ...
        <div className="sticky top-19 w-full rounded-2xl bg-white overflow-hidden mt-9">
            ...
            <div className="w-full p-4 flex flex-col gap-4">
                ...
                <div className="w-full flex flex-col gap-3">
                    <InputBox icon={ticketSVG} label="Generate a Ticket" placeholder="Ticket code" buttonText="Generate & Print" value="AE_101919" />
                    <InputBox icon={ticketSVG} label="Ticket Code" placeholder="Enter ticket code" buttonText="Search" />
                    <CardRow title="Nausheen" attribute="Using 2 Ticket" />
                    <CardRow title="Livaa" attribute="Using 1 Ticket" />
                    <CardRow title="Other" attribute="Using 286 Ticket" />
                    <hr />
                    <div className="flex items-center justify-between w-full px-3">
                        <h1 className="text-lg font-bold">Capacity</h1>
                        <p className="text-2xl font-bold text-[#0E7490]">289/320</p>
                    </div>
