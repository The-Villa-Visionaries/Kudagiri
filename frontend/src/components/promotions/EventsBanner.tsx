        ...
        <div className="relative w-full h-70 bg-linear-to-r from-[#0E7490] to-[#06B6D3] rounded-2xl overflow-hidden z-10">
            ...
            <div className="absolute top-0 w-full">
                <button className="absolute left-0 w-15 h-70 flex items-center justify-center">
                    <img src={naviButtSVG} alt="Left Arrow" className="w-8 h-8 rounded-full bg-white/30 p-1 transition-transform duration-300 hover:scale-115" />
                </button>
                <button className="absolute right-0 w-15 h-70 flex items-center justify-center">
                    <img src={naviButtSVG} alt="Right Arrow" className="w-8 h-8 rotate-180 rounded-full bg-white/30 p-1 transition-transform duration-300 hover:scale-115" />
                </button>
            </div>
