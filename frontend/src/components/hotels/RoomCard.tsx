    ...
    return (
        <div className="w-[calc(50%-50px)] bg-white rounded-2xl shadow-md overflow-hidden">
            <div className="relative w-full h-48 overflow-hidden">
                <img src="https://five-star-alliance.s3.amazonaws.com/field/image/nodes/2017/45956/0_villa-G.jpg" alt="Room" className="w-full h-48 object-cover transition-transform duration-500 ease-in-out hover:scale-110 active:scale-95 hover:cursor-pointer"/>
            </div>
            <div className="p-4"> 
                ...
                <div className="flex items-center gap-3 mt-1"> 
                    <div className="mr-1 flex items-center gap-1 mt-2">
                        <img src={doubleSVG} alt="Guest" className="w-5 h-5 inline-block"/>
                        <p className="text-[#558282] text-sm">Upto 2 guests</p>
                    </div>
                    <div className="mr-1 flex items-center gap-1 mt-2">
                        <img src={roomsizeSVG} alt="Room Size" className="w-5 h-5 inline-block"/>
                        <p className="text-[#558282] text-sm">95 m²</p>
                    </div>
                    <div className="mr-1 flex items-center gap-1 mt-2">
                        <img src={bedSVG} alt="Bed" className="w-5 h-5 inline-block"/>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button className="bg-[#0E7490] text-white px-4 py-2 rounded-full font-bold hover:bg-[#0891B2] transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95 hover:cursor-pointer">Book Now</button>
                </div>
            </div>
        </div>
    )
